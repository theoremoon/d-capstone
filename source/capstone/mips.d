...
enum mips_op_type
{
    ...
    MIPS_OP_REG = 1, ///< = CS_OP_REG (Register operand).
    MIPS_OP_IMM = 2, ///< = CS_OP_IMM (Immediate operand).
    MIPS_OP_MEM = 3 ///< = CS_OP_MEM (Memory operand).
}
...
enum mips_reg
{
    ...
    MIPS_REG_ENDING = 137, // <-- mark the end of the list or registers
...
enum mips_insn
{
    ...
    MIPS_INS_JALR_HB = 624, // jump and link with Hazard Barrier
    MIPS_INS_JR_HB = 625, // jump register with Hazard Barrier
...
enum mips_insn_group
{
    ...
    MIPS_GRP_JUMP = 1, ///< = CS_GRP_JUMP
    // all call instructions
    MIPS_GRP_CALL = 2, ///< = CS_GRP_CALL
    // all return instructions
    MIPS_GRP_RET = 3, ///< = CS_GRP_RET
    // all interrupt instructions (int+syscall)
    MIPS_GRP_INT = 4, ///< = CS_GRP_INT
    // all interrupt return instructions
    MIPS_GRP_IRET = 5, ///< = CS_GRP_IRET
    // all privileged instructions
    MIPS_GRP_PRIVILEGE = 6, ///< = CS_GRP_PRIVILEGE
    // all relative branching instructions
    MIPS_GRP_BRANCH_RELATIVE = 7, ///< = CS_GRP_BRANCH_RELATIVE
