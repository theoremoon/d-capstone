...
enum evm_insn
{
    ...
    EVM_INS_INVALID = 512,
    EVM_INS_ENDING = 513 // <-- mark the end of the list of instructions
}
...
enum evm_insn_group
{
    ...
    EVM_GRP_JUMP = 1, ///< all jump instructions

    EVM_GRP_MATH = 8, ///< math instructions
    EVM_GRP_STACK_WRITE = 9, ///< instructions write to stack
    EVM_GRP_STACK_READ = 10, ///< instructions read from stack
    EVM_GRP_MEM_WRITE = 11, ///< instructions write to memory
    EVM_GRP_MEM_READ = 12, ///< instructions read from memory
    EVM_GRP_STORE_WRITE = 13, ///< instructions write to storage
    EVM_GRP_STORE_READ = 14, ///< instructions read from storage
    EVM_GRP_HALT = 15, ///< instructions halt execution

    EVM_GRP_ENDING = 16 ///< <-- mark the end of the list of groups
}
