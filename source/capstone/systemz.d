...
enum sysz_op_type
{
    ...
    SYSZ_OP_REG = 1, ///< = CS_OP_REG (Register operand).
    SYSZ_OP_IMM = 2, ///< = CS_OP_IMM (Immediate operand).
    SYSZ_OP_MEM = 3, ///< = CS_OP_MEM (Memory operand).
...
enum sysz_insn
{
    ...
    SYSZ_INS_ENDING = 682 // <-- mark the end of the list of instructions
}
...
enum sysz_insn_group
{
    ...
    SYSZ_GRP_ENDING = 133 // <-- mark the end of the list of groups
}
