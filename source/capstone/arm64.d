...
enum arm64_op_type
{
    ...
    ARM64_OP_REG = 1, ///< = CS_OP_REG (Register operand).
    ARM64_OP_IMM = 2, ///< = CS_OP_IMM (Immediate operand).
    ARM64_OP_MEM = 3, ///< = CS_OP_MEM (Memory operand).
    ARM64_OP_FP = 4, ///< = CS_OP_FP (Floating-Point operand).
    ARM64_OP_CIMM = 64, ///< C-Immediate
    ARM64_OP_REG_MRS = 65, ///< MRS register operand.
    ARM64_OP_REG_MSR = 66, ///< MSR register operand.
    ARM64_OP_PSTATE = 67, ///< PState operand.
    ARM64_OP_SYS = 68, ///< SYS operand for IC/DC/AT/TLBI instructions.
    ARM64_OP_PREFETCH = 69, ///< Prefetch operand (PRFM).
    ARM64_OP_BARRIER = 70 ///< Memory barrier operand (ISB/DMB/DSB instructions).
}
...
enum arm64_insn
{
    ...
    ARM64_INS_ENDING = 454 // <-- mark the end of the list of insn
}
...
enum arm64_insn_group
{
    ...
    ARM64_GRP_JUMP = 1, ///< = CS_GRP_JUMP
    ARM64_GRP_CALL = 2,
    ARM64_GRP_RET = 3,
    ARM64_GRP_INT = 4,
    ARM64_GRP_PRIVILEGE = 6, ///< = CS_GRP_PRIVILEGE
    ARM64_GRP_BRANCH_RELATIVE = 7, ///< = CS_GRP_BRANCH_RELATIVE
    ...
    ARM64_GRP_ENDING = 132 // <-- mark the end of the list of groups
}
